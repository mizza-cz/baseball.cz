...
(function () {
  ...
  tables.forEach((table) => {
    ...
    headers.forEach((th, index) => {
      th.addEventListener("click", function () {
        ...
        sortTable(tbody, index, type, direction);
        updateActiveColumn(table, index);
  ...
  function updateActiveColumn(table, columnIndex) {
    table.querySelectorAll(".bg-line").forEach((el) => {
      el.classList.remove("bg-line");
    });
